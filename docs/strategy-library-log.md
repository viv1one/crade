...
| 4 | Consistent Momentum Strategy | A | (this commit) | Cross-sectional momentum filtered to symbols positive in ≥minPositiveMonths of the last lookbackMonths calendar months, ranked by total window return among eligible symbols. Test demonstrates the filter rejecting a one-spike-then-decline symbol (+20% raw return, 1/3 positive months) in favor of a steadier one (+15% raw return, 3/3 positive months). Sanity-checked live against the full NIFTY 50 (1y, daily): 43 trades, -6.6% return vs. +14.9% buy-and-hold. |
